module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!((jest-)?react-native|@react-native(-community)?|@react-navigation/.*|@expo/.*|expo(?:-.*)?|react-native-reanimated|react-native-image-colors|react-native-markdown-display)/)',
  ],
  moduleNameMapper: {
